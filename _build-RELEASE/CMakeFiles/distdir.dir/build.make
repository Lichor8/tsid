...
CMakeFiles/distdir:
	...
	cd /opt/openrobots/src/tsid-fork && rm -f /tmp/tsid.tar && /opt/openrobots/src/tsid-fork/cmake/git-archive-all.sh --prefix tsid-1.1.0-5-g8574-dirty/ tsid.tar && cd /opt/openrobots/src/tsid-fork/_build-RELEASE/ && ( test -d tsid-1.1.0-5-g8574-dirty && find tsid-1.1.0-5-g8574-dirty/ -type d -print0 | xargs -0 chmod a+w || true ) && rm -rf tsid-1.1.0-5-g8574-dirty/ && /bin/tar xf /opt/openrobots/src/tsid-fork/tsid.tar && echo 1.1.0-5-g8574-dirty > /opt/openrobots/src/tsid-fork/_build-RELEASE/tsid-1.1.0-5-g8574-dirty/.version && /opt/openrobots/src/tsid-fork/cmake/gitlog-to-changelog > /opt/openrobots/src/tsid-fork/_build-RELEASE/tsid-1.1.0-5-g8574-dirty/ChangeLog && rm -f /opt/openrobots/src/tsid-fork/tsid.tar
