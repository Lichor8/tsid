...
doc/header.html:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/opt/openrobots/src/tsid-fork/_build-RELEASE/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating Doxygen template files"
	cd /opt/openrobots/src/tsid-fork/_build-RELEASE/doc && /usr/local/bin/doxygen -w html /opt/openrobots/src/tsid-fork/_build-RELEASE/doc/header.html /opt/openrobots/src/tsid-fork/_build-RELEASE/doc/footer.html /opt/openrobots/src/tsid-fork/_build-RELEASE/doc/doxygen.css
